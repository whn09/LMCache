...
if [[ $1 == "prefiller" ]]; then
    ...
    UCX_TLS=cuda_ipc,cuda_copy,tcp \
        ...
        --enforce-eager \
        --kv-transfer-config \
        '{"kv_connector":"LMCacheConnectorV1","kv_role":"kv_producer","kv_connector_extra_config": {"discard_partial_chunks": false, "lmcache_rpc_port": "producer"}}'
    ...
    # Prefiller listens on port 8201
    decode_config_file=$SCRIPT_DIR/configs/lmcache-decoder-config.yaml
    ...
    UCX_TLS=cuda_ipc,cuda_copy,tcp \
        ...
        --enforce-eager \
        --kv-transfer-config \
        '{"kv_connector":"LMCacheConnectorV1","kv_role":"kv_consumer","kv_connector_extra_config": {"discard_partial_chunks": false, "lmcache_rpc_port": "consumer2"}}'
